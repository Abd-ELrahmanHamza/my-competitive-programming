...
//    }
//
//    bool prefixExist(char *str, int &minCnt) {
//        if (*str == '\0')
//            return true;
//        else {
//            int cur = *str - 'a';
...
//                return false;
//            }
//            minCnt = min(minCnt, cnt[cur]);
//            return child[cur]->prefixExist(str + 1, minCnt);
//        }
//    }
//};
//
...
//    ll temp = p / 2;
//    if (root > x && root > y)
//        return LCA(temp, level + 1, (2 * I - 1));
//
//    if (root < x && root < y)
//        return LCA(temp, level + 1, 2 * I);
//
//
//    return root;
//}
...
//        cin >> height >> x >> y;
//        ll lowestCA = -1;
//        lowestCA = LCA((ll) pow(2, (height - 1)), 1, 1);
//        cout << lowestCA << endl;
//
//    }
//    return 0;
